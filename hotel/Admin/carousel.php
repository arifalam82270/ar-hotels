      ...
      <?php require('inc/header.php');?>
        ...
        <div class="container-fluid" id="main-content">
            <div class="row">
                ...
                <div class="modal fade" id="carousel-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1"  aria-hidden="true">
                        <div class="modal-dialog">
                            <form id="carousel_s_from">
                               ...
                               <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <input type="file" name="carousel_picture" required id="member_picture_inp" accept=".jpg ,.png ,.webp ,.jpeg" class="form-control shadow-none">
