   ...
   ?>
    <nav id="nav-bar" class="navbar navbar-expand-lg navbar-light    bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
             ...
             <div class="container-fluid">
                <a class="navbar-brand me-5 fw-bold fe-3 h-font" href="index.php">AR HOTELS</a>
        ...
        <div class="modal fade" id="loginModel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <form >
                ...
                <i class="bi bi-person-circle fs-2 me-3"></i>User login</h5>
        ...
        <div class="modal fade" id="registerModel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <form id="register-form" >
                ...
                <span class="badge rounded-pill text-dark bg-light mb-3 text-wrap lh-base">
                    Note : Your details must math with your ID(Aadhar card,passport,driving licensce ete..)
                    that will require during check-in.
                </span>
                <div class="container-fluid">
